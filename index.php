	...
	<article class="offer" id="offer">
		<div class="container">
			...
			<div class="col-sm-4">
				...
				<a href="blaty.php" class="more-button">Więcej Informacji</a>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="item">
				...
				<a href="fronty.php" class="more-button">Więcej Informacji</a>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="item">
				...
				<a href="mnw.php" class="more-button">Więcej Informacji</a>
				</div>
			</div>
			</div>
		</div>
